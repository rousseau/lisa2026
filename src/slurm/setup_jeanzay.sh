...
echo ""
echo "   sbatch src/slurm/train_jeanzay.slurm"
echo ""
echo "   # Surcharger un paramètre :"
echo "   sbatch src/slurm/train_jeanzay.slurm --epochs 200 --batch-size 2"
echo ""
echo "   # Utiliser une config alternative :"
echo "   sbatch src/slurm/train_jeanzay.slurm --config configs/train_large.yaml"
echo "======================================================================="
